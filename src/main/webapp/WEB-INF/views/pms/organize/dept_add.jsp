...
<head>
    ...
    <script src="resources/systemManagement/organizeManagement/js/dept_add.js"></script>
    <link rel="stylesheet" href="resources/systemManagement/organizeManagement/css/dept_add.css">
</head>
<body>
