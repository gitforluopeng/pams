...
<head>
    ...
    <script src="resources/systemManagement/organizeManagement/js/unit_edit.js"></script>
    <link rel="stylesheet" href="resources/systemManagement/organizeManagement/css/unit_edit.css">
    ...
    <div id="div-form">
        <div style="margin-top: 20px;width: 100%;" class="layui-inline">
            ...
            <div style="width: 350px;height:40px;margin-left: 18px" class="layui-inline">
                <input id="unitname"  class="layui-input">
            </div>
        </div>
