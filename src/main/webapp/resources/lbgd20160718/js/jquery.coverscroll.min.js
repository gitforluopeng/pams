        ...
        init: function(f) {
            ...
            function e(l, m, j) {
                ...
                if (n = m.attr("title")) {
                    ...
                    c('<div style="position:absolute;text-align:center;font-size: 18px;top:' + o + "px;left:" + (k - o / 2) + "px;width:" + (o * 2) + 'px" class="' + g.titleclass + '">' + n + "</div>").appendTo(l);
                    setTimeout(function() {
