...
<input style="display:none" id="resumeId">
</div>
</body>
<script>
        ...
        function init_data(){
        	$.ajax({
        		...
        		success: function (data){
        			...
        			chatUploadId.val(fileInfo.id);
        			console.info(fileInfo);
        			resumeId.val(personMsg.id);
        ...
        function init_select(){
         ...
         function init_saveBtn(){
        	saveBtn.on('click',function(){
        		...
        		$.ajax({
        			type: 'get',
        			url: 'personResumeManage/update_personResume',
        			data: {
        				"personResume.chatUploadId": chatUploadId.val(),
        				"personResume.id": resumeId.val(),
