...
<div id="div-all" class="layui-form" lay-filter="selectdiv">
    <div id="div-form">
        ...
        <div style="margin-top: 30px;margin-left: auto;width: 100%;" class="layui-inline">
        	<div style="margin-left: 50px;width:70px;" class="layui-inline"><font color="red">*&nbsp;</font>扣减项目:</div>
		...
		function init_saveBtn(){
			saveBtn.on('click',function(){
				...
				$.ajax({
					...
					data: {
						"salary.userId" : window.parent.document.data.shiroUserId,
						"salary.userName" : window.parent.document.data.userName,
						"salary.personName" : window.parent.document.data.personName,
						"salary.unitId" : window.parent.document.data.unitId,
						"salary.unitName" : window.parent.document.data.unitName,
						"salary.deptId" : window.parent.document.data.deptId,
						"salary.deptName" : window.parent.document.data.deptName,
