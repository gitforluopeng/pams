...
<div style="width:100%;height: 98%;border-bottom: solid 1px silver;margin: 0px auto;" class="layui-form" lay-filter="selectdiv">
    ...
    <div id="div-add-toolbar" style="width: 100%;height: 70px;background-color: #F3F3F3;">
        ...
        <div class="layui-inline" style="float: right;margin-top: 15px;margin-right: 40px">
            <button id="addBtn" class="layui-btn layui-btn-danger">考勤历史</button>
        </div>
    </div>
...
<script type="text/html" id="barDemo">
    <a style="color: #33cc78;cursor: pointer;margin-left:10px;" lay-event="start">开始考勤</a>
    <a style="color: #33cc78;cursor: pointer;margin-left:10px;" lay-event="detail">考勤详情</a>
</script>
			...
			table.on('tool(tabletool)', function(obj) {
				...
				if (layEvent == "start") {
					...
					parent.layer.open({
						...
						shade : 0.8,
						area : [ '30%', '50%' ],
						content : 'attendanceManage/begin_attendance', //iframe的url
						end : function() {
							table.reload('reload');
						}
					})
					...
					parent.layer.open({
						...
						shade : 0.8,
						area : [ '80%', '85%' ],
						content : 'attendanceManage/show_attendance', //iframe的url
						end : function() {
							table.reload('reload');
						}
					})
